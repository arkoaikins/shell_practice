...
/**
 * free_agt - Frees up memory taken by agt.
 * @agt: A null-terminated double pointer containing cmds/arguments.
 ...
 * Description: Opens the stat file, a space-dlimited file containing
...
/**
 * _replacer - Handles variable replacement.
 * @line: A double pointer containing the cmd and arguments.
 * @impret: A pointer to the return value of the last performd cmd.
 *
 * Description: Replaces $$ with the current PID, $? with the return value
 *              of the last performd program, and envrionmental variables
